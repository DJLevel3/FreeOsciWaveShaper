...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FOWS Demo Installer\n"
      else:
        line="OutputBaseFilename=FOWS Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FOWS Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FOWS installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FOWS Demo installer\n"
     else:
       line="SetupWindowTitle=FOWS installer\n"
