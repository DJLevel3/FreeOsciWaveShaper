...
def main():
  ...
  plistpath = scriptpath + "/resources/FOWS-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FOWS-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FOWS-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FOWS-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FOWS-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FOWS.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FOWS.iss",inplace=1):
